...
public final class RMDataSkriningGiziLanjut extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("1.  Skor IMT, CDC ,WHO z-Score");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(79, 100, 335, 23);

        cmbSkor1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "IMT 18,5-25", "IMT > 25", "IMT < 18,5", "CDC Obesitas >120%", "CDC Overweight 110-120%", "CDC GIzi Baik 90-110%", "CDC Gizi kurang 70-90%", "CDC Gizi Buruk <70%", "BB/U < -3SD sd < -2SD", "BB/U -2SD sd +1SD", "BB/U +1SD", "PB/U dan TB/U < -3SD sd < -2SD", "PB/U dan TB/U -2SD sd +3SD", "PB/U dan TB/U +3SD", "BB/PB dan BB/TB < -3SD sd < -2SD ", "BB/PB dan BB/TB -2SD sd +1SD", "BB/PB dan BB/TB > +1SD sd +3SD" }));
    ...
    */
    ...
    private void isCombo1(){
       if((cmbSkor1.getSelectedItem().equals("IMT > 25"))||(cmbSkor1.getSelectedItem().equals("CDC Obesitas >120%"))||
                (cmbSkor1.getSelectedItem().equals("CDC Overweight 110-120%"))||(cmbSkor1.getSelectedItem().equals("BB/U +1SD"))||
                (cmbSkor1.getSelectedItem().equals("PB/U dan TB/U +3SD"))||(cmbSkor1.getSelectedItem().equals("BB/PB dan BB/TB > +1SD sd +3SD")))
        {
          Skor1.setText("1");  
        }
        else if((cmbSkor1.getSelectedItem().equals("IMT < 18,5"))||(cmbSkor1.getSelectedItem().equals("CDC Gizi kurang 70-90%")) ||
                (cmbSkor1.getSelectedItem().equals("CDC Gizi Buruk <70%"))||(cmbSkor1.getSelectedItem().equals("BB/U < -3SD sd < -2SD"))||
                (cmbSkor1.getSelectedItem().equals("PB/U dan TB/U < -3SD sd < -2SD "))||(cmbSkor1.getSelectedItem().equals("BB/PB dan BB/TB < -3SD sd < -2SD")))
        {
          Skor1.setText("2");
        }
        else
