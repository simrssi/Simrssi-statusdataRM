...
public final class RMMCU extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-03-2023 11:23:58" }));
        ...
        Submandibula.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Membesar", "Membesar" }));
        ...
        Leher.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Membesar", "Membesar" }));
        ...
        Axila.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Membesar", "Membesar" }));
        ...
        Inguinal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Membesar", "Membesar" }));
        ...
        Supraklavikula.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Membesar", "Membesar" }));
        ...
        Palpebra.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Normal", "Oedem", "Ptosis" }));
        ...
        Palpebra.setBounds(162, 450, 110, 23);

        Sklera.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Normal", "Ikterik" }));
        ...
        Sklera.setBounds(329, 450, 110, 23);

        TestButaWarna.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Normal", "Buta Warna Partial", "Buta Warna Total" }));
        ...
        Konjungtiva.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Normal", "Anemis", "Hiperemis" }));
        ...
        Konjungtiva.setBounds(162, 480, 110, 23);

        Lensa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Jernih", "Keruh", "Kacamata" }));
        ...
        FormInput.add(Lensa);
        Lensa.setBounds(329, 480, 110, 23);

        Cornea.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Normal", "Tidak Normal" }));
        ...
        Pupil.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Isokor", "Anisokor" }));
        ...
        LubangTelinga.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Lapang", "Sempit", "Serumen Prop" }));
        ...
        DaunTelinga.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Normal", "Tidak Normal" }));
        ...
        SelaputPendengaran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Intak", "Tidak Intak" }));
        ...
        NyeriMastoideus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Ada", "Ada" }));
        ...
        NyeriMastoideus.setBounds(756, 530, 110, 23);
        ...
        SeptumNasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Normal", "Deviasi" }));
        ...
        SeptumNasi.setBounds(166, 580, 110, 23);
        ...
        LubangHidung.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Lapang", "Rhinore", "Epistaksis" }));
        ...
        LubangHidung.setBounds(444, 580, 110, 23);
        ...
        Bibir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Lembab", "Kering" }));
        ...
        FormInput.add(Bibir);
        Bibir.setBounds(127, 630, 110, 23);

        Caries.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Ada", "Ada" }));
        ...
        Caries.setBounds(287, 630, 110, 23);

        Lidah.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Bersih", "Kotor", "Tremor" }));
        ...
        FormInput.add(Lidah);
        Lidah.setBounds(452, 630, 110, 23);

        Faring.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Normal", "Hiperemis" }));
        ...
        Faring.setBounds(610, 630, 110, 23);

        Tonsil.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "T1-T1", "T2-T2", "T3-T3", "T4-T4", "T0-T0" }));
        ...
        Tonsil.setBounds(774, 630, 110, 23);
        ...
        KelenjarLimfe.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Membesar", "Membesar" }));
        ...
        KelenjarGondok.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Membesar", "Membesar" }));
        ...
        jLabel83.setBounds(640, 750, 100, 23);
        ...
        GerakanDada.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Simetris", "Tidak Simetris" }));
        ...
        BunyiNapas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Vesikuler", "Bronkhial", "Trakeal" }));
        ...
        VocalFremitus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Sama", "Tidak Sama" }));
        ...
        BunyiTambahan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Ada", "Wheezing", "Tronkhi" }));
        ...
        PerkusiDada.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Sonor", "Pekak" }));
        ...
        PerkusiDada.setBounds(740, 750, 110, 23);
        ...
        jLabel87.setBounds(640, 830, 100, 23);
        ...
        IctusCordis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Terlihat", "Terlihat", "Teraba", "Tidak Teraba" }));
        ...
        BunyiJantung.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Reguler", "Irreguler", "Korotkoff I, II", "Gallop", "Lain-lain" }));
        ...
        Batas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Normal", "Melebar" }));
        ...
        FormInput.add(Batas);
        Batas.setBounds(740, 830, 110, 23);

        Inspeksi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Datar", "Cembung" }));
        ...
        Palpasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Supel", "Tegang (Defans Muscular)" }));
        ...
        PerkusiAbdomen.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Timpani", "Hipertimpani" }));
        ...
        Auskultasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Normal", "Meningkat (>4x/menit)" }));
        ...
        Hepar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Membesar", "Membesar" }));
        ...
        Limpa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Membesar", "Membesar" }));
        ...
        NyeriKtok.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak diPeriksa", "Tidak Ada", "Ada" }));
