...
public final class SuratKeteranganSehat extends javax.swing.JDialog {
    ...
    private int i=0;
    private String tgl,finger="",kodedokter="",namadokter="",pekerjaan="",darah="";
    ...
    public SuratKeteranganSehat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Tensi","Keperluan","Kesimpulan","Pemeriksaan","Laboratorium","Rontgen","EKG"
        }){
...
//        Suhu.setDocument(new batasInput((byte)4).getKata(Suhu));
    ...
    private void initComponents() {
        ...
        Laborat = new javax.swing.JTextArea();
        jLabel10 = new widget.Label();
        jScrollPane3 = new javax.swing.JScrollPane();
        RO = new javax.swing.JTextArea();
        jLabel11 = new widget.Label();
        jScrollPane4 = new javax.swing.JScrollPane();
        EKG = new javax.swing.JTextArea();
        ...
        internalFrame1.setPreferredSize(new java.awt.Dimension(700, 620));
        ...
        PanelInput.setMinimumSize(new java.awt.Dimension(100, 19));
        PanelInput.setName("PanelInput"); // NOI18N
        PanelInput.setOpaque(false);
        PanelInput.setPreferredSize(new java.awt.Dimension(400, 150));
        PanelInput.setLayout(new java.awt.BorderLayout(1, 1));

        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(100, 150));
        ...
        kesimpulan.setBounds(310, 70, 220, 23);
        ...
        jLabel28.setBounds(230, 70, 75, 23);

        TanggalSurat.setForeground(new java.awt.Color(50, 70, 50));
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-04-2023" }));
        ...
        jLabel8.setText("Laboratorium :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(740, 10, 70, 23);
        ...
        jScrollPane2.setViewportView(Laborat);

        FormInput.add(jScrollPane2);
        jScrollPane2.setBounds(820, 10, 234, 40);

        jLabel10.setText("Rongten :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(1050, 10, 70, 20);
        ...
        RO.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ROKeyPressed(evt);
            }
        });
        jScrollPane3.setViewportView(RO);

        FormInput.add(jScrollPane3);
        jScrollPane3.setBounds(1120, 10, 234, 40);

        jLabel11.setText("EKG :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(910, 60, 70, 23);
        ...
        jScrollPane4.setViewportView(EKG);

        FormInput.add(jScrollPane4);
        jScrollPane4.setBounds(990, 60, 234, 40);

        jLabel29.setText("Pemeriksaan :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(540, 70, 75, 23);

        cmbpemeriksaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pemeriksaan Fisik", "Pemeriksaan Fisik serta Pemeriksaan Penunjang" }));
        cmbpemeriksaan.setName("cmbpemeriksaan"); // NOI18N
        cmbpemeriksaan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbpemeriksaanKeyPressed(evt);
            }
        });
        FormInput.add(cmbpemeriksaan);
        cmbpemeriksaan.setBounds(620, 70, 320, 23);
        ...
        Keperluan.setBounds(80, 70, 150, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            Valid.textKosong(kesimpulan,"Keperluan");
        }else{
            if(Sequel.menyimpantf("surat_keterangan_sehat","?,?,?,?,?,?,?,?,?,?,?,?","No.Surat",12,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Bb.getText(),Tb.getText(),Tensi.getText(),
                    Keperluan.getText(),kesimpulan.getText(),cmbpemeriksaan.getSelectedItem()+"",Laborat.getText(),RO.getText(),EKG.getText()
                })==true){
                tampil();
                emptTeks();
            }
...
//        }
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_keterangan_sehat","no_surat=?","no_surat=?,no_rawat=?,tanggalsurat=?,berat=?,tinggi=?,tensi=?,keperluan=?,kesimpulan=?,pemeriksaan=?,Laborat=?,RO=?,EKG=?",13,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Bb.getText(),Tb.getText(),Tensi.getText(),
                    Keperluan.getText(),kesimpulan.getText(),cmbpemeriksaan.getSelectedItem()+"", Laborat.getText(),RO.getText(),EKG.getText(),
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratKeteranganSehat.jasper","report","::[ Data Surat Keterangan Sehat ]::",
                     ...
                     "surat_keterangan_sehat.tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.tensi,surat_keterangan_sehat.pemeriksaan, "+                  
    ...
    private void MnCetakSuratSehatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSehatActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("darah",Sequel.cariIsi("select gol_darah from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where reg_periksa.no_rawat=?",TNoRw.getText()));
                ...
                param.put("finger","Surat atas nama "+TPasien.getText()+" dengan No.Surat:"+NoSurat.getText()+"/445/RSUD.UM.MCU Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+namadokter+"\nID "+(finger.equals("")?kodedokter:finger)+"\n"+Sequel.cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()));  
                Valid.MyReportqry("rptSuratKeteranganSehat.jasper","report","::[ Surat Keterangan Sehat ]::",
                              " select surat_keterangan_sehat.no_surat,DATE_FORMAT(surat_keterangan_sehat.tanggalsurat,'%d-%m-%Y')as tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.tensi, "+
                              " surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,surat_keterangan_sehat.pemeriksaan,surat_keterangan_sehat.Laborat,surat_keterangan_sehat.RO,surat_keterangan_sehat.EKG,dokter.nm_dokter,pasien.jk,reg_periksa.kd_dokter," +
    ...
    private void TanggalSuratKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalSuratKeyPressed
        Valid.pindah(evt,TCari,kesimpulan);
    ...
    if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                Valid.MyReportqry("rptSuratKeteranganSehat2.jasper","report","::[ Surat Keterangan Sehat ]::",
                              " select surat_keterangan_sehat.no_surat,DATE_FORMAT(surat_keterangan_sehat.tanggalsurat,'%d-%m-%Y')as tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.tensi,   "+
                              " surat_keterangan_sehat.butawarna,surat_keterangan_sehat.keperluan,surat_keterangan_sehat.kesimpulan,surat_keterangan_sehat.Laborat,surat_keterangan_sehat.RO,surat_keterangan_sehat.EKG,dokter.nm_dokter,pasien.jk,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y')as tgl_lahir,reg_periksa.kd_dokter, " +
                              " pasien.nm_pasien,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat" +
                              " from surat_keterangan_sehat inner join reg_periksa inner join pasien inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten" +
                              " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kel=kelurahan.kd_kel and "+
                              " pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab and reg_periksa.no_rawat=surat_keterangan_sehat.no_rawat "+
    ...
    private void TensiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TensiKeyPressed
        Valid.pindah(evt,Tb,Laborat);
    }//GEN-LAST:event_TensiKeyPressed

    private void kesimpulanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kesimpulanKeyPressed
        Valid.pindah(evt,Keperluan,cmbpemeriksaan);
    }//GEN-LAST:event_kesimpulanKeyPressed

    private void EKGKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_EKGKeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,RO,BtnSimpan);
    }//GEN-LAST:event_EKGKeyPressed

    private void ROKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ROKeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,Laborat,Keperluan);
    }//GEN-LAST:event_ROKeyPressed

    private void LaboratKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LaboratKeyPressed
        // TODO add your handling code here:
        Valid.pindah(evt,Tensi,RO);
    }//GEN-LAST:event_LaboratKeyPressed

    private void cmbpemeriksaanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbpemeriksaanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbpemeriksaanKeyPressed
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_sehat.no_surat,surat_keterangan_sehat.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_sehat.tanggalsurat,surat_keterangan_sehat.berat,surat_keterangan_sehat.tinggi,surat_keterangan_sehat.tensi,surat_keterangan_sehat.keperluan, "+                  
                     "surat_keterangan_sehat.kesimpulan,surat_keterangan_sehat.pemeriksaan,surat_keterangan_sehat.Laborat,surat_keterangan_sehat.RO,surat_keterangan_sehat.EKG from surat_keterangan_sehat inner join reg_periksa on surat_keterangan_sehat.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
...
//        Suhu.setText("");
        ...
        cmbpemeriksaan.setSelectedItem("Pemeriksaan Fisik");
        kesimpulan.getText();
        Laborat.setText("");
        RO.setText("");
        EKG.setText("");
        Valid.autoNomer3("select ifnull(MAX(CONVERT(surat_keterangan_sehat.no_surat,signed)),0) from surat_keterangan_sehat where surat_keterangan_sehat.tanggalsurat='"+Valid.SetTgl(TanggalSurat.getSelectedItem()+"")+"' ","",3,NoSurat);
...
//            CmbButaWarna.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            ...
            cmbpemeriksaan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
            Laborat.setText(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
            RO.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
            EKG.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
        }
    }
