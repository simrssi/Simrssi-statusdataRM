...
public final class SuratSakit extends javax.swing.JDialog {
    ...
    public SuratSakit(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat Sakit","No.Rawat","No.R.M.","Nama Pasien","Dari Tanggal","Sampai Tanggal","Lama Sakit","Ket","Tanggal Pulang"
        }){
...
//        Ket.setDocument(new batasInput((byte)1000).getKata(Ket));
    ...
    private void initComponents() {
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-04-2023" }));
        ...
        jLabel18.setText("Ket :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(730, 40, 30, 23);

        TanggalAwal.setForeground(new java.awt.Color(50, 70, 50));
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-04-2023" }));
        ...
        FormInput.add(Ket);
        Ket.setBounds(770, 40, 106, 23);

        jLabel20.setText("Lama Sakit :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(540, 40, 70, 23);
        ...
        jLabel14.setText("Tanggal Pulang :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(730, 10, 80, 23);

        tgl_pulang.setForeground(new java.awt.Color(50, 70, 50));
        tgl_pulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-04-2023" }));
        tgl_pulang.setDisplayFormat("dd-MM-yyyy");
        tgl_pulang.setName("tgl_pulang"); // NOI18N
        tgl_pulang.setOpaque(false);
        tgl_pulang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tgl_pulangActionPerformed(evt);
            }
        });
        tgl_pulang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tgl_pulangKeyPressed(evt);
            }
        });
        FormInput.add(tgl_pulang);
        tgl_pulang.setBounds(810, 10, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(Ket.getText().trim().equals("")){
            Valid.textKosong(LamaSakit,"ket");
        }else if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"pasien");
        }else{
            if(Sequel.menyimpantf("suratsakit","?,?,?,?,?,?,?","No.Surat Sakit",7,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalAwal.getSelectedItem()+""),Valid.SetTgl(TanggalAkhir.getSelectedItem()+""),LamaSakit.getText(),Ket.getText(),Valid.SetTgl(tgl_pulang.getSelectedItem()+"")
                })==true){
                tampil();
                emptTeks();
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("suratsakit","no_surat=?","no_surat=?,no_rawat=?,tanggalawal=?,tanggalakhir=?,lamasakit=?,ket=?,tgl_pulang=?",7,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalAwal.getSelectedItem()+""),Valid.SetTgl(TanggalAkhir.getSelectedItem()+""),LamaSakit.getText(),Ket.getText(),Valid.SetTgl(tgl_pulang.getSelectedItem()+""),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                })==true){
                    tampil();
                    emptTeks();
                }
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratSakit.jasper","report","::[ Data Surat Sakit Pasien ]::",
                     ...
                     "suratsakit.tanggalawal,suratsakit.tanggalakhir,suratsakit.lamasakit,suratsakit.ket,suratsakit.tgl_pulang "+                  
    ...
    private void MnCetakSuratSakitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakitActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("tgl_keluar", tgl_pulang.getSelectedItem().toString());
...
//                param.put("pasien",Sequel.cariIsi("Select  "))
    ...
    private void tgl_pulangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tgl_pulangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tgl_pulangActionPerformed

    private void tgl_pulangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tgl_pulangKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tgl_pulangKeyPressed
    ...
    */
    ...
    private widget.Tanggal tgl_pulang;
    ...
    public void tampil() {
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ...
                ps=koneksi.prepareStatement(
                     "select suratsakit.no_surat,suratsakit.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "suratsakit.tanggalawal,suratsakit.tanggalakhir,suratsakit.lamasakit,suratsakit.ket,suratsakit.tgl_pulang t "+                  
                     "from suratsakit inner join reg_periksa on suratsakit.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "where "+tgl+"and no_surat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and suratsakit.no_rawat like '%"+TCari.getText().trim()+"%' or "+
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(suratsakit.no_surat,signed)),0) from suratsakit where suratsakit.tanggalawal='"+Valid.SetTgl(TanggalAwal.getSelectedItem()+"")+"' ","",3,NoSurat); 
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Ket.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());
            Valid.SetTgl(tgl_pulang,tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
