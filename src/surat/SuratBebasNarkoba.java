...
public final class SuratBebasNarkoba extends javax.swing.JDialog {
    ...
    public SuratBebasNarkoba(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat Sakit","No.Rawat","No.R.M.","Nama Pasien","Tanggal Surat","Kategori","KD Dokter","Dokter","Keperluan","No.Lab",
            "Opiat/Morphin","Ganja/Canabis","Amphetamin","Methampetamin","Benzodiazepin","Cocain","Keterangan"
    ...
    private void initComponents() {
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-04-2023" }));
        ...
        jLabel20.setText("THC / Marijuana /");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(30, 130, 100, 20);
        ...
        jLabel22.setBounds(130, 130, 10, 23);
        ...
        jLabel23.setText("Morphin / Opiat  :");
        ...
        jLabel28.setBounds(720, 70, 63, 23);
        ...
        jScrollPane1.setBounds(790, 70, 234, 86);

        jLabel29.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel29.setText("Canabinoid / Ganja");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(40, 140, 100, 20);

        jLabel30.setText("Keperluan :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(423, 70, 63, 23);

        jLabel31.setText("No.Lab :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(720, 40, 63, 23);

        nolab.setHighlighter(null);
        nolab.setName("nolab"); // NOI18N
        nolab.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                nolabKeyPressed(evt);
            }
        });
        FormInput.add(nolab);
        nolab.setBounds(790, 40, 225, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_skbn","?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Surat SKBN",14,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Kategori.getSelectedItem().toString(),KdDok.getText(),nolab.getText(),
                    Keperluan.getText(),hasil1.getSelectedItem().toString(),hasil2.getSelectedItem().toString(),hasil3.getSelectedItem().toString(),
                    hasil4.getSelectedItem().toString(),hasil5.getSelectedItem().toString(),hasil6.getSelectedItem().toString(),ket.getText()
                })==true){
                tampil();
                emptTeks();
            }else{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_skbn","no_surat=?","no_surat=?,no_rawat=?,tanggalsurat=?,kategori=?,kd_dokter=?,nolab=?,keperluan=?,opiat=?,ganja=?,amphetamin=?,methamphetamin=?,benzodiazepin=?,cocain=?,ket=?",15,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Kategori.getSelectedItem().toString(),KdDok.getText(),nolab.getText(),Keperluan.getText(),hasil1.getSelectedItem().toString(),
                    hasil2.getSelectedItem().toString(),hasil3.getSelectedItem().toString(),hasil4.getSelectedItem().toString(),hasil5.getSelectedItem().toString(),hasil6.getSelectedItem().toString(),ket.getText(),
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratSKBN.jasper","report","::[ Data Surat Keterangan Bebas Narkoba ]::",
                     ...
                     "surat_skbn.opiat,surat_skbn.ganja,surat_skbn.amphetamin,surat_skbn.methamphetamin,surat_skbn.benzodiazepin,surat_skbn.cocain,surat_skbn.ket,surat_skbn.nolab "+                   
                ...
                Valid.MyReportqry("rptDataSuratSKBN.jasper","report","::[ Data Surat Keterangan Pasien ]::",
                     "select surat_skbn.no_surat,surat_skbn.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                     "surat_skbn.tanggalsurat,surat_skbn.kategori,surat_skbn.kd_dokter,dokter.nm_dokter,surat_skbn.keperluan, "+
                     "surat_skbn.opiat,surat_skbn.ganja,surat_skbn.amphetamin,surat_skbn.methamphetamin,surat_skbn.benzodiazepin,surat_skbn.cocain,cocain,surat_skbn.ket,surat_skbn.nolab "+                   
                     "from surat_skbn inner join reg_periksa on surat_skbn.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_skbn.kd_dokter=dokter.kd_dokter "+
    ...
    private void MnCetakSuratSKBNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSKBNActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("ket",ket.getText());
//                param.put("gol_darah,")
                param.put("nolab",nolab.getText());
                param.put("namars",akses.getnamars());
                param.put("alamatrs",akses.getalamatrs());
                param.put("kotars",akses.getkabupatenrs());
                param.put("propinsirs",akses.getpropinsirs());
                param.put("kontakrs",akses.getkontakrs());
                param.put("emailrs",akses.getemailrs());  
                param.put("tinggi",Sequel.cariIsi("Select tinggi from pemeriksaan_ralan inner join surat_skbn on surat_skbn.no_rawat=pemeriksaan_ralan.no_rawat where pemeriksaan_ralan.no_rawat=?",TNoRw.getText()));
                param.put("berat",Sequel.cariIsi("Select berat from pemeriksaan_ralan inner join surat_skbn on surat_skbn.no_rawat=pemeriksaan_ralan.no_rawat where pemeriksaan_ralan.no_rawat=?",TNoRw.getText()));
                ...
                param.put("finger","Surat atas nama "+TPasien.getText()+" dengan No.Surat:"+NoSurat.getText()+"/445/RSUD.UM.KPN Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+TDokter.getText()+"\nID "+(finger.equals("")?KdDok.getText():finger)+"\n"+TanggalSurat.getSelectedItem());  
                param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                Valid.MyReportqry("rptBebasNarkoba1.jasper","report","::[ Surat SKBN 1 ]::",
                              ...
                              " pasien.tmp_lahir,pasien.agama,pasien.nm_pasien,pasien.jk,pasien.gol_darah,pasien.pekerjaan,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat,suku_bangsa.nama_suku_bangsa,reg_periksa.kd_dokter " +
    ...
    private void nolabKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nolabKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_nolabKeyPressed
    ...
    */
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_skbn.no_surat,surat_skbn.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                     "surat_skbn.tanggalsurat,surat_skbn.kategori,surat_skbn.kd_dokter,dokter.nm_dokter,surat_skbn.nolab,surat_skbn.keperluan, "+
                     "surat_skbn.opiat,surat_skbn.ganja,surat_skbn.amphetamin,surat_skbn.methamphetamin,surat_skbn.benzodiazepin,surat_skbn.cocain,surat_skbn.ket "+                   
                     "from surat_skbn inner join reg_periksa on surat_skbn.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                     "inner join dokter on surat_skbn.kd_dokter=dokter.kd_dokter "+
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            nolab.setText(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            hasil1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
            hasil2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
            hasil3.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
            hasil4.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            hasil5.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            hasil6.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString()); 
            ket.setText(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString()); 
        }
    }
    ...
    private void autoSKBN() {
        Valid.autoNomer3("select ifnull(MAX(CONVERT(surat_skbn.no_surat,signed)),0) from surat_skbn where surat_skbn.tanggalsurat='"+Valid.SetTgl(TanggalSurat.getSelectedItem()+"")+"' ","",3,NoSurat); 
    }
