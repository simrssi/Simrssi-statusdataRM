 ...
 * @author dosen
 */
public final class DlgCariCaraBayar1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariCaraBayar1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariCaraBayar1 dialog = new DlgCariCaraBayar1(new javax.swing.JFrame(), true);
