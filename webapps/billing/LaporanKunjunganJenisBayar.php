              ...
              echo "<table width='100%'  border='1' align='left' cellpadding='0' cellspacing='0' class='tbl_form'>
                     ...
                     while($baris = mysqli_fetch_array($hasil)) { 
                       ...
                       echo "<tr class='isi15'>
                               <td>$i &nbsp;</td>
                               <td>".$baris[1]." &nbsp;</td>
                               <td>".getOne("select count(reg_periksa.no_rawat) from reg_periksa where reg_periksa.kd_pj='$baris[0]' and reg_periksa.tgl_registrasi between '$tanggal1' and '$tanggal2' and reg_periksa.stts_daftar='Lama'")." &nbsp;</td>
